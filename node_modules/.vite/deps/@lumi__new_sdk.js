  ...
  "node_modules/object-hash/dist/object_hash.js"(exports, module) {
    !function(e) {
      ...
      return function r2(o, i, u2) {
        ...
        !(function(e, n2, s, c2, d, h, p2, g2, y) {
          "use strict";
          var r2 = w2("crypto");
          function t(e2, t2) {
            t2 = u2(e2, t2);
        ...
        !(function(e2, n2, f2, r2, h, p2, g2, y, w2) {
          ...
          H2.Buffer = f2, H2.SlowBuffer = f2, H2.INSPECT_MAX_BYTES = 50, f2.poolSize = 8192, f2._useTypedArrays = function() {
            ...
            switch ((!n3 || a3 < (n3 = Number(n3))) && (n3 = a3), r3 = String(r3 || "utf8").toLowerCase()) {
              ...
              case "utf8":
              case "utf-8":
                i2 = this, u3 = t2, s2 = n3, o2 = f2._charsWritten = c2(T2(e3), i2, u3, s2);
                break;
              case "ascii":
              case "binary":
                o2 = b2(this, e3, t2, n3);
            ...
            var n3 = this.length;
            if (e3 = S2(e3, n3, 0), t2 = S2(t2, n3, n3), f2._useTypedArrays)
      ...
      }, { buffer: 3, lYpoI2: 11 }], 5: [function(v, e, _2) {
        !(function(l, c2, u2, d, h, p2, g2, y, w2) {
          var u2 = v("buffer").Buffer, e2 = v("./sha"), t = v("./sha256"), n2 = v("./rng"), b2 = { sha1: e2, sha256: t, md5: v("./md5") }, s = 64, a2 = new u2(s);
          function r2(e3, n3) {
      ...
      }, { "./md5": 6, "./rng": 7, "./sha": 8, "./sha256": 9, buffer: 3, lYpoI2: 11 }], 6: [function(w2, b2, e) {
        !(function(e2, r2, o, i, u2, a2, f2, l, y) {
          var t = w2("./helpers");
          function n2(e3, t2) {
          ...
          function p2(e3, t2, n3, r3, o2, i2, u3) {
        ...
        !(function(e2, t, n2, r2, o, s, a2, f2, l) {
          ...
          function u2(l2, c3) {
            ...
            for (var e3, t2, n3, r3 = Array(80), o2 = 1732584193, i2 = -271733879, u3 = -1732584194, s2 = 271733878, d2 = -1009589776, h = 0; h < l2.length; h += 16) {
              for (var p2 = o2, g2 = i2, y = u3, w2 = s2, b2 = d2, a3 = 0; a3 < 80; a3++) {
                r3[a3] = a3 < 16 ? l2[h + a3] : v(r3[a3 - 3] ^ r3[a3 - 8] ^ r3[a3 - 14] ^ r3[a3 - 16], 1);
                var f3 = m2(m2(v(o2, 5), (f3 = i2, t2 = u3, n3 = s2, (e3 = a3) < 20 ? f3 & t2 | ~f3 & n3 : !(e3 < 40) && e3 < 60 ? f3 & t2 | f3 & n3 | t2 & n3 : f3 ^ t2 ^ n3)), m2(m2(d2, r3[a3]), (e3 = a3) < 20 ? 1518500249 : e3 < 40 ? 1859775393 : e3 < 60 ? -1894007588 : -899497514)), d2 = s2, s2 = u3, u3 = v(i2, 30), i2 = o2, o2 = f3;
              }
              o2 = m2(o2, p2), i2 = m2(i2, g2), u3 = m2(u3, y), s2 = m2(s2, w2), d2 = m2(d2, b2);
            }
        ...
        !(function(e2, t, n2, r2, u2, s, a2, f2, l) {
          ...
          function o(e3, l2) {
            ...
            for (var r3, o2, h = 0; h < e3.length; h += 16) {
              for (var i2 = t2[0], u3 = t2[1], s2 = t2[2], p2 = t2[3], a3 = t2[4], g2 = t2[5], y = t2[6], w2 = t2[7], f3 = 0; f3 < 64; f3++)
                n3[f3] = f3 < 16 ? e3[f3 + h] : b2(b2(b2((o2 = n3[f3 - 2], m2(o2, 17) ^ m2(o2, 19) ^ v(o2, 10)), n3[f3 - 7]), (o2 = n3[f3 - 15], m2(o2, 7) ^ m2(o2, 18) ^ v(o2, 3))), n3[f3 - 16]), c3 = b2(b2(b2(b2(w2, m2(o2 = a3, 6) ^ m2(o2, 11) ^ m2(o2, 25)), a3 & g2 ^ ~a3 & y), d2[f3]), n3[f3]), r3 = b2(m2(r3 = i2, 2) ^ m2(r3, 13) ^ m2(r3, 22), i2 & u3 ^ i2 & s2 ^ u3 & s2), w2 = y, y = g2, g2 = a3, a3 = b2(p2, c3), p2 = s2, s2 = u3, u3 = i2, i2 = b2(c3, r3);
              t2[0] = b2(i2, t2[0]), t2[1] = b2(u3, t2[1]), t2[2] = b2(s2, t2[2]), t2[3] = b2(p2, t2[3]), t2[4] = b2(a3, t2[4]), t2[5] = b2(g2, t2[5]), t2[6] = b2(y, t2[6]), t2[7] = b2(w2, t2[7]);
            }
            return t2;
          }
...
function sha1(bytes) {
  ...
  for (let i = 0; i < N2; ++i) {
    ...
    for (let t = 0; t < 80; ++t) {
      ...
      const T2 = ROTL(a2, 5) + f(s, b2, c2, d) + e + K2[s] + W2[t] >>> 0;
      e = d;
      d = c2;
      c2 = ROTL(b2, 30) >>> 0;
      b2 = a2;
...
var z = (i, e, t) => e in i ? X(i, e, { enumerable: true, configurable: true, writable: true, value: t }) : i[e] = t;
var S = (i, e) => {
  for (var t in e || (e = {}))
    te.call(e, t) && z(i, t, e[t]);
  if (_)
    for (var t of _(e))
      ie.call(e, t) && z(i, t, e[t]);
  return i;
};
var N = (i, e) => W(i, ee(e));
var Q = (i, e, t) => e.has(i) || K("Cannot " + t);
var n = (i, e, t) => (Q(i, e, "read from private field"), t ? t.call(i) : e.get(i));
var a = (i, e, t) => e.has(i) ? K("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(i) : e.set(i, t);
var u = (i, e, t, r2) => (Q(i, e, "write to private field"), r2 ? r2.call(i, t) : e.set(i, t), t);
var m = (i, e, t) => new Promise((r2, s) => {
  var o = (h) => {
    try {
      f2(t.next(h));
    } catch (y) {
  ...
  }, f2 = (h) => h.done ? r2(h.value) : Promise.resolve(h.value).then(o, l);
...
var le = "6QrJZ7pFCmBZAeIJF7IArvkCz+EtzA0RVcpHkiQIsQyhs7QtCS9P+CueZdHfB2OtJcgX3BbqY9pfpWeAVTqCwQ==";
function V(i) {
  return encodeURIComponent(i).replace(/[!'()*]/g, (e) => `%${e.charCodeAt(0).toString(16).toUpperCase()}`);
}
function ue(i) {
  return (e) => {
    let { options: t } = e, r2 = Math.floor(Date.now() / 1e3).toString(), s = Math.random().toString(36).substring(2, 15), o = S({}, t.query), l = Object.keys(o).sort().map((E) => `${V(E)}=${V(String(o[E]))}`).join("&"), f2 = { "x-timestamp": r2, "x-nonce": s }, h = Object.keys(f2).sort().map((E) => `${E}:${f2[E]}`).join(`
`), y = t.body && !(t.body instanceof FormData) ? JSON.stringify(t.body) : "", R = (0, import_sha256.default)(y).toString(import_enc_hex.default), v = [l, h, R].join(`
`), d = import_enc_base64.default.stringify((0, import_hmac_sha256.default)(v, i)), I = new Headers(t.headers);
    Object.entries(f2).forEach(([E, Z]) => {
      I.set(E, Z);
    }), I.set("X-Sign", d), t.headers = I;
  };
}
var Y = /* @__PURE__ */ new Map();
function me(i, e) {
  var o;
  e.body instanceof FormData && (e = N(S({}, e), { body: Array.from(e.body.entries()) }));
  let t = (0, import_object_hash.default)([i, e]), r2 = Date.now(), s = ((o = Y.get(t)) == null ? void 0 : o.filter((l) => r2 - l < 1e3)) || [];
  if (s.length >= 4)
    throw new b(429, "Too many requests");
  s.push(r2), Y.set(t, s);
}
function c(i, e, t = {}) {
  i.auth.accessToken && (t.headers = S({ Authorization: `Bearer ${i.auth.accessToken}` }, t.headers)), me(e, t);
  let r2 = i.auth.isAuthenticated;
  return ofetch(e, N(S({ baseURL: i.config.apiBaseUrl }, t), { onRequest: ue(le), onResponse: ({ response: s }) => {
    var o;
    !w && r2 && ((o = s._data) == null ? void 0 : o.code) === 2100 && i.auth.signOut();
  } }));
}
function F(i, e, t = localStorage) {
  let r2 = t.getItem(i), s = e ? JSON.stringify(e) : null;
  s ? t.setItem(i, s) : t.removeItem(i), window.dispatchEvent(new StorageEvent("storage", { key: i, oldValue: r2, newValue: s, storageArea: t }));
}
function B(i, e = localStorage) {
  let t = e.getItem(i);
  try {
...
var P = class {
  constructor(e) {
    a(this, g);
    a(this, O, `lumi-auth-${v4_default()}`);
    a(this, L, null);
    u(this, g, e), Promise.resolve().then(() => {
      !w && this.isAuthenticated && this.refreshUser();
    });
  }
  get accessToken() {
    if (w) {
      let e = n(this, g).config.authorization;
      return e ? e.replace("Bearer ", "") : null;
    }
    return B("lumi-access-token");
  }
  set accessToken(e) {
    if (w) {
      n(this, g).config.authorization = e ? `Bearer ${e}` : void 0;
      return;
    }
    F("lumi-access-token", e);
  }
  get user() {
    return w ? n(this, L) : B("lumi-user");
  }
  set user(e) {
    if (w) {
      u(this, L, e);
  ...
  signIn() {
    ...
    let e = 800, t = 600, r2 = (window.screen.width - e) / 2, s = (window.screen.height - t) / 2, o = window.open(n(this, g).config.authOrigin, n(this, O), `width=${e},height=${t},left=${r2},top=${s}`), l;
    return new Promise((f2, h) => {
      if (!o)
        return h(new Error("Open auth window failed"));
      let y = setInterval(() => {
        o.closed && h(new Error("Auth window closed"));
      }, 1e3), R = (d) => {
        o.closed || (o.focus(), d.stopPropagation(), d.preventDefault());
      }, v = ({ data: d, origin: I, source: E }) => {
        if (!(I !== n(this, g).config.authOrigin || E !== o))
          switch (d == null ? void 0 : d.type) {
            case "lumi-ready": {
              o.postMessage({ type: "lumi-init", data: { projectId: n(this, g).config.projectId, icon: J(), title: G() } }, n(this, g).config.authOrigin);
              break;
            }
            case "lumi-sign-in": {
              if (d.data.projectId !== n(this, g).config.projectId)
                break;
              o.close(), window.focus(), this.accessToken = d.data.accessToken, this.user = d.data.user, f2(d.data);
              break;
            }
          }
      };
      window.addEventListener("message", v), document.addEventListener("click", R, true), l = () => {
        clearInterval(y), window.removeEventListener("message", v), document.removeEventListener("click", R, true);
      };
  ...
  refreshUser() {
    return m(this, null, function* () {
      let e = yield c(n(this, g), "/lm/user/info", { method: "POST" });
      if (e.code !== 200)
...
g = /* @__PURE__ */ new WeakMap(), O = /* @__PURE__ */ new WeakMap(), L = /* @__PURE__ */ new WeakMap();
var p;
var D = class {
  constructor(e, t) {
    a(this, p);
    u(this, p, e), this.entityName = t;
  }
  list() {
    return m(this, arguments, function* ({ filter: e, sort: t, limit: r2, skip: s } = {}) {
      if (r2) {
        let o = yield c(n(this, p), this.uri("/find"), { method: "POST", body: { filter: e, sort: t, limit: r2, skip: s } });
        if (o.code !== 200)
          throw new Error(o.message);
        return o.data;
      } else {
        let o = yield c(n(this, p), this.uri("/list"), { method: "POST", body: { filter: e, sort: t } });
        if (o.code !== 200)
          throw new Error(o.message);
        return { total: o.data.length, list: o.data };
      }
    });
  }
  get(e) {
    return m(this, null, function* () {
      let t = yield c(n(this, p), this.uri(`/${e}`), { method: "GET" });
      if (t.code !== 200)
  ...
  create(e) {
    return m(this, null, function* () {
      let t = yield c(n(this, p), this.uri(), { method: "POST", body: e });
      if (t.code !== 200)
        throw new Error(t.message);
      return t.data;
    });
  ...
  createMany(e) {
    return m(this, null, function* () {
      let t = yield c(n(this, p), this.uri("/batch"), { method: "POST", body: e });
      if (t.code !== 200)
        throw new Error(t.message);
      return t.data;
    });
  ...
  update(e, t) {
    return m(this, null, function* () {
      let r2 = yield c(n(this, p), this.uri(), { method: "PUT", body: { filter: { _id: e }, update: t } });
      if (r2.code !== 200)
  ...
  delete(e) {
    return m(this, null, function* () {
      let t = yield c(n(this, p), this.uri(`/${e}`), { method: "DELETE" });
      if (t.code !== 200)
        throw new Error(t.message);
    });
  }
  deleteMany(e) {
    return m(this, null, function* () {
      let t = yield c(n(this, p), this.uri("/batch-by-ids"), { method: "DELETE", params: { ids: e } });
      if (t.code !== 200)
        throw new Error(t.message);
    });
  }
  uri(e = "") {
    return `/lm/${n(this, p).config.projectId}/${this.entityName}/documents${e}`;
  }
};
...
var M = class {
  constructor(e) {
    a(this, x);
    return u(this, x, e), new Proxy(this, { get(t, r2) {
      return r2 in t || (t[r2] = new D(n(t, x), r2)), t[r2];
    } });
  }
};
...
var U = class {
  ...
  invoke(e, t = {}) {
    return n(this, C).auth.accessToken && (t.headers = S({ Authorization: `Bearer ${n(this, C).auth.accessToken}` }, t.headers)), ofetch(`/v1/functions/${n(this, C).config.projectId}/${e}`, S({ baseURL: n(this, C).config.apiBaseUrl }, t));
  }
};
...
var k = class {
  ...
  send(h) {
    return m(this, arguments, function* ({ to: e, subject: t, fromName: r2, html: s, text: o = "", replyTo: l, scheduledAt: f2 }) {
      if (!e || !t || !s && !o)
        throw new Error("Failed to send email: Missing required parameters.");
      typeof e == "string" && (e = [e]), typeof l == "string" && (l = [l]);
      let y = yield c(n(this, A), `/lm/${n(this, A).config.projectId}/email/send`, { method: "POST", body: { to: e, subject: t, fromName: r2, html: s, text: o, replyTo: l, scheduledAt: f2 } });
      if (y.code !== 200)
        throw new b(y.code, y.message);
    });
  }
};
...
var $ = class {
  ...
  upload(e) {
    return m(this, null, function* () {
      ...
      let r2 = yield c(n(this, T), `/lm/${n(this, T).config.projectId}/file/batch`, { method: "POST", body: t });
      if (r2.code !== 200)
        throw new b(r2.code, r2.message);
      return r2.data;
    });
  }
  delete(e) {
    return m(this, null, function* () {
      let t = yield c(n(this, T), `/lm/${n(this, T).config.projectId}/file/batch`, { method: "DELETE", body: { fileUrls: e } });
      if (t.code !== 200)
        throw new b(t.code, t.message);
    });
  }
};
...
var q = class {
  constructor(e) {
    a(this, j);
    u(this, j, e), this.email = new k(e), this.file = new $(e);
  }
};
j = /* @__PURE__ */ new WeakMap();
var H = class {
  constructor(e) {
    this.config = e, this.auth = new P(this), this.entities = new M(this), this.tools = new q(this), this.functions = new U(this);
  }
};
function nt(i) {
  return new H(i);
